...
const getFacilitiesByUserEmail = async (token, userEmail) => {
	...
	try {
		...
		console.log(`❌ Error! Facilities NOT found.`, err);
		return err.message;
	}
};
/**
...
const getFacilityInfo = async (token, facilityID) => {
	...
	try {
		...
		console.log("❌ Oops. Your 'getFacilityInfo' request failed:", err);
		return err.message;
	}
};
/**
...
const getFacilityCategories = async (token, index = 0, rows = 50) => {
	...
	try {
		...
		console.log("❌ Oops. Request ('getFacilityCategories') failed: ", err);
		return err.message;
	}
};
/**
...
const getShifts = async (token, index = 0, rows = 10) => {
	...
	try {
		...
		console.log("❌ Oops. Request ('getShifts') failed: ", err);
		return err.message;
	}
};
